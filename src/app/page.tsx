...
export default function Home() {
  return (
    <div>
      <header className="hero" onClick={e => document.querySelector('#dasa-sahasragalarchana')?.scrollIntoView({ behavior: 'smooth', block: 'end' })}>
      ...
      <section className="cta-section">
        <div className="hero-container">
          ...
          <Carousel id="dasa-sahasragalarchana" directory="media/dasa-sahasragalarchana" alt="Dasa Sahasra Galarchana First Class Commencement" />
          ...
          <p style={{fontSize:"large", cursor: "default", userSelect: "none"}}>
            <q><br />
          ...
          <Carousel id="margazhi-isai-vizha" directory="media/margazhi-isai-vizha" alt="Margazhi Isai Vizha 2026" />
        </div>
      </section>
    </div>
  );
